...
void ASmain ()
{
	...
	// specialization
	{
		...
		spec.AddToRenderTech( "RayTracing.RTech", "RayTrace" );
		...
		// shader binding table
		{
			...
			sbt.BindHitGroup( "TriHit",	InstanceIndex(1),	RayIndex(0) );	// traceRays() with sbtRecordOffset = 2
			sbt.BindHitGroup( "TriHit",	InstanceIndex(1),	RayIndex(1) );	// traceRays() with sbtRecordOffset = 3
		}
	}
}
