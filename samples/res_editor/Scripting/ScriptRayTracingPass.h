...
namespace AE::ResEditor
{
    struct RTMissIndex
    {
        ...
        RTMissIndex () {}
        explicit RTMissIndex (uint v) : value{v} {}
    };
    ...
    public:
        ...
        void  HitGroupStride (uint stride)                                                                  __Th___;
        void  SetRayMiss (const RTMissIndex &missIndex, const RTShader &sh)                                 __Th___;
