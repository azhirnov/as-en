...
=================================================
*/
    void  ScriptBuffer::Float1 (const String &name, float x) __Th___
    {
    ...
    void  ScriptBuffer::Float2v (const String &name, const packed_float2 &v) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &v, Sizeof(v), 8_b );
        _layout.source << "  float2  " << name << ";\n";
    }

    void  ScriptBuffer::Float3v (const String &name, const packed_float3 &v) __Th___
    {
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Float4v (const String &name, const packed_float4 &v) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &v, Sizeof(v), 16_b );
...
=================================================
*/
    void  ScriptBuffer::Float2x2 (const String &name, const packed_float2x2 &m) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &m, Sizeof(m), 16_b );
        _layout.source << "  float2x2  " << name << ";\n";
    }

    void  ScriptBuffer::Float2x3 (const String &name, const packed_float2x3 &m) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &m, Sizeof(m), 16_b );
    ...
    void  ScriptBuffer::Float2x4 (const String &name, const packed_float2x4 &m) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &m, Sizeof(m), 16_b );
    ...
    void  ScriptBuffer::Float3x2 (const String &name, const packed_float3x2 &m) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &m, Sizeof(m), 16_b );
    ...
    void  ScriptBuffer::Float3x3 (const String &name, const packed_float3x3 &m) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &m, Sizeof(m), 16_b );
    ...
    void  ScriptBuffer::Float3x4 (const String &name, const packed_float3x4 &m) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &m, Sizeof(m), 16_b );
    ...
    void  ScriptBuffer::Float4x2 (const String &name, const packed_float4x2 &m) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &m, Sizeof(m), 16_b );
    ...
    void  ScriptBuffer::Float4x3 (const String &name, const packed_float4x3 &m) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &m, Sizeof(m), 16_b );
    ...
    void  ScriptBuffer::Float4x4 (const String &name, const packed_float4x4 &m) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &m, Sizeof(m), 16_b );
...
*/
    ...
    void  ScriptBuffer::Int2v (const String &name, const packed_int2 &v) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &v, Sizeof(v), 8_b );
    ...
    void  ScriptBuffer::Int3v (const String &name, const packed_int3 &v) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &v, Sizeof(v), 16_b );
    ...
    void  ScriptBuffer::Int4v (const String &name, const packed_int4 &v) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &v, Sizeof(v), 16_b );
...
*/
    ...
    void  ScriptBuffer::UInt2v (const String &name, const packed_uint2 &v) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &v, Sizeof(v), 8_b );
    ...
    void  ScriptBuffer::UInt3v (const String &name, const packed_uint3 &v) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &v, Sizeof(v), 16_b );
    ...
    void  ScriptBuffer::UInt4v (const String &name, const packed_uint4 &v) __Th___
    {
        _InitConstDataFromScriptLayout();
        _layout.Put( &v, Sizeof(v), 16_b );
...
=================================================
*/
    void  ScriptBuffer::Float1Array (const String &name, const ScriptArray<float> &arr) __Th___
    {
    ...
    void  ScriptBuffer::Float2Array (const String &name, const ScriptArray<packed_float2> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Float3Array (const String &name, const ScriptArray<packed_float3> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();

        for (auto x : arr) {
            _layout.Put( &x, Sizeof(x), 16_b );
        }
        _layout.source << "  float3  " << name << " [" << ToString(arr.size()) << "];\n";
    }

    void  ScriptBuffer::Float4Array (const String &name, const ScriptArray<packed_float4> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
...
=================================================
*/
    void  ScriptBuffer::Float2x2Array (const String &name, const ScriptArray<packed_float2x2> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Float2x3Array (const String &name, const ScriptArray<packed_float2x3> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Float2x4Array (const String &name, const ScriptArray<packed_float2x4> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Float3x2Array (const String &name, const ScriptArray<packed_float3x2> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Float3x3Array (const String &name, const ScriptArray<packed_float3x3> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Float3x4Array (const String &name, const ScriptArray<packed_float3x4> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Float4x2Array (const String &name, const ScriptArray<packed_float4x2> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Float4x3Array (const String &name, const ScriptArray<packed_float4x3> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Float4x4Array (const String &name, const ScriptArray<packed_float4x4> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
...
=================================================
*/
    void  ScriptBuffer::Int1Array (const String &name, const ScriptArray<int> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Int2Array (const String &name, const ScriptArray<packed_int2> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Int3Array (const String &name, const ScriptArray<packed_int3> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::Int4Array (const String &name, const ScriptArray<packed_int4> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
...
=================================================
*/
    void  ScriptBuffer::UInt1Array (const String &name, const ScriptArray<uint> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::UInt2Array (const String &name, const ScriptArray<packed_uint2> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::UInt3Array (const String &name, const ScriptArray<packed_uint3> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    void  ScriptBuffer::UInt4Array (const String &name, const ScriptArray<packed_uint4> &arr) __Th___
    {
        CHECK_THROW_MSG( not arr.empty() );
        _InitConstDataFromScriptLayout();
    ...
    RC<Buffer>  ScriptBuffer::ToResource () __Th___
    {
        ...
        for (auto usage = _resUsage; usage != Default;)
        {
            ...
            switch ( ExtractBit( INOUT usage ))
            {
                ...
                case EResourceUsage::VertexInput :      _desc.usage |= EBufferUsage::Vertex;                                    break;
