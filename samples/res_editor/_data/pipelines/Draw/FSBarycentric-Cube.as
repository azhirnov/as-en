...
//-----------------------------------------------------------------------------
    ...
    {
        {
            RC<DescriptorSetLayout> ds = DescriptorSetLayout( "fsbarycentric.mtr.ds" );
            ds.UniformBuffer( EShaderStages::Vertex, "un_PerObject",    ArraySize(1), "UnifiedGeometryMaterialUB" );
            ds.StorageBuffer( EShaderStages::Vertex, "un_Cube",         ArraySize(1), "fsbarycentric.CubeUBlock", EAccessType::Coherent, EResourceState::ShaderStorage_Read );  // external
        }{
            RC<PipelineLayout>      pl = PipelineLayout( "fsbarycentric.pl" );
            pl.DSLayout( "pass",     0, "pass.ds" );
            pl.DSLayout( "material", 1, "fsbarycentric.mtr.ds" );
        }

        {
            RC<GraphicsPipeline>    ppln = GraphicsPipeline( "fsbarycentric.draw1" );
            ppln.SetLayout( "fsbarycentric.pl" );
            ...
            // specialization
            {
                RC<GraphicsPipelineSpec>    spec = ppln.AddSpecialization( "fsbarycentric.draw1" );
