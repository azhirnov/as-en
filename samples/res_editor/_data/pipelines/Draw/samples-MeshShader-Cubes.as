...
//-----------------------------------------------------------------------------
    ...
    void ASmain ()
    {
        ...
        // pipeline layout
        {
            ...
            ds.StorageBuffer( EShaderStages::MeshTask | EShaderStages::Mesh, "un_Cube",      ArraySize(1), "CubeSBlock", EAccessType::Coherent, EResourceState::ShaderStorage_Read );  // external
