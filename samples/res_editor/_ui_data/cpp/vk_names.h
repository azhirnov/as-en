namespace RenderTechs
{
    ...
    static constexpr struct _Histogram_RTech
    {
        ...
        static constexpr struct _Graphics
        {
            ...
            // RenderPass 'Histogram.RPass.def' subpass 'Main'
        ...
        static constexpr struct _Compute
        {
            ...
            // pipelines
            static constexpr PipelineName_t  Histogram_CSPass1_def {"Histogram.CSPass1.def"};
            static constexpr PipelineName_t  Histogram_CSPass2_def {"Histogram.CSPass2.def"};
        } Compute;
    } Histogram_RTech;
