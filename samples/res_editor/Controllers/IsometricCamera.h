...
namespace AE::ResEditor
{
    ...
    class IsometricCamera final : public IController
    {
    // variables
    private:
        ...
        OrbitalCameraTempl<float>   _camera;
    ...
    // methods
    public:
        IsometricCamera (RC<DynamicDim> dim, float2 clipPlanes, Rad fovY,
        ...
        InputModeName   GetInputMode ()                                 C_NE_OV { return InputModeName{"Controller.Isometric"}; }
