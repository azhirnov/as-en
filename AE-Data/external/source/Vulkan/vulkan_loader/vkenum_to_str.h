ND_ String  VkFormatToString (const VkFormat value)
{
	switch ( value )
	{
		...
		case VK_FORMAT_A1B5G5R5_UNORM_PACK16_KHR : return "A1B5G5R5_UNORM_PACK16";
		case VK_FORMAT_A8_UNORM_KHR : return "A8_UNORM";
	}
	return "<unknown>";
}
...
ND_ String  VkStructureTypeToString (const VkStructureType value)
{
	switch ( value )
	{
		...
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_CAPABILITIES_KHR : return "VIDEO_ENCODE_H264_CAPABILITIES";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_PARAMETERS_CREATE_INFO_KHR : return "VIDEO_ENCODE_H264_SESSION_PARAMETERS_CREATE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_PARAMETERS_ADD_INFO_KHR : return "VIDEO_ENCODE_H264_SESSION_PARAMETERS_ADD_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_PICTURE_INFO_KHR : return "VIDEO_ENCODE_H264_PICTURE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_DPB_SLOT_INFO_KHR : return "VIDEO_ENCODE_H264_DPB_SLOT_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_NALU_SLICE_INFO_KHR : return "VIDEO_ENCODE_H264_NALU_SLICE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_GOP_REMAINING_FRAME_INFO_KHR : return "VIDEO_ENCODE_H264_GOP_REMAINING_FRAME_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_PROFILE_INFO_KHR : return "VIDEO_ENCODE_H264_PROFILE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_RATE_CONTROL_INFO_KHR : return "VIDEO_ENCODE_H264_RATE_CONTROL_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_RATE_CONTROL_LAYER_INFO_KHR : return "VIDEO_ENCODE_H264_RATE_CONTROL_LAYER_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_CREATE_INFO_KHR : return "VIDEO_ENCODE_H264_SESSION_CREATE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_QUALITY_LEVEL_PROPERTIES_KHR : return "VIDEO_ENCODE_H264_QUALITY_LEVEL_PROPERTIES";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_PARAMETERS_GET_INFO_KHR : return "VIDEO_ENCODE_H264_SESSION_PARAMETERS_GET_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_PARAMETERS_FEEDBACK_INFO_KHR : return "VIDEO_ENCODE_H264_SESSION_PARAMETERS_FEEDBACK_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_CAPABILITIES_KHR : return "VIDEO_ENCODE_H265_CAPABILITIES";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_CREATE_INFO_KHR : return "VIDEO_ENCODE_H265_SESSION_PARAMETERS_CREATE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_ADD_INFO_KHR : return "VIDEO_ENCODE_H265_SESSION_PARAMETERS_ADD_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_PICTURE_INFO_KHR : return "VIDEO_ENCODE_H265_PICTURE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_DPB_SLOT_INFO_KHR : return "VIDEO_ENCODE_H265_DPB_SLOT_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_NALU_SLICE_SEGMENT_INFO_KHR : return "VIDEO_ENCODE_H265_NALU_SLICE_SEGMENT_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_GOP_REMAINING_FRAME_INFO_KHR : return "VIDEO_ENCODE_H265_GOP_REMAINING_FRAME_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_PROFILE_INFO_KHR : return "VIDEO_ENCODE_H265_PROFILE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_RATE_CONTROL_INFO_KHR : return "VIDEO_ENCODE_H265_RATE_CONTROL_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_RATE_CONTROL_LAYER_INFO_KHR : return "VIDEO_ENCODE_H265_RATE_CONTROL_LAYER_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_CREATE_INFO_KHR : return "VIDEO_ENCODE_H265_SESSION_CREATE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_QUALITY_LEVEL_PROPERTIES_KHR : return "VIDEO_ENCODE_H265_QUALITY_LEVEL_PROPERTIES";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_GET_INFO_KHR : return "VIDEO_ENCODE_H265_SESSION_PARAMETERS_GET_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_FEEDBACK_INFO_KHR : return "VIDEO_ENCODE_H265_SESSION_PARAMETERS_FEEDBACK_INFO";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RELAXED_LINE_RASTERIZATION_FEATURES_IMG : return "PHYSICAL_DEVICE_RELAXED_LINE_RASTERIZATION_FEATURES_IMG";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ENQUEUE_FEATURES_AMDX : return "PHYSICAL_DEVICE_SHADER_ENQUEUE_FEATURES_AMDX";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ENQUEUE_PROPERTIES_AMDX : return "PHYSICAL_DEVICE_SHADER_ENQUEUE_PROPERTIES_AMDX";
		case VK_STRUCTURE_TYPE_EXECUTION_GRAPH_PIPELINE_SCRATCH_SIZE_AMDX : return "EXECUTION_GRAPH_PIPELINE_SCRATCH_SIZE_AMDX";
		case VK_STRUCTURE_TYPE_EXECUTION_GRAPH_PIPELINE_CREATE_INFO_AMDX : return "EXECUTION_GRAPH_PIPELINE_CREATE_INFO_AMDX";
		case VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_NODE_CREATE_INFO_AMDX : return "PIPELINE_SHADER_STAGE_NODE_CREATE_INFO_AMDX";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_FEATURES_EXT : return "PHYSICAL_DEVICE_HOST_IMAGE_COPY_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_PROPERTIES_EXT : return "PHYSICAL_DEVICE_HOST_IMAGE_COPY_PROPERTIES";
		case VK_STRUCTURE_TYPE_MEMORY_TO_IMAGE_COPY_EXT : return "MEMORY_TO_IMAGE_COPY";
		case VK_STRUCTURE_TYPE_IMAGE_TO_MEMORY_COPY_EXT : return "IMAGE_TO_MEMORY_COPY";
		case VK_STRUCTURE_TYPE_COPY_IMAGE_TO_MEMORY_INFO_EXT : return "COPY_IMAGE_TO_MEMORY_INFO";
		case VK_STRUCTURE_TYPE_COPY_MEMORY_TO_IMAGE_INFO_EXT : return "COPY_MEMORY_TO_IMAGE_INFO";
		case VK_STRUCTURE_TYPE_HOST_IMAGE_LAYOUT_TRANSITION_INFO_EXT : return "HOST_IMAGE_LAYOUT_TRANSITION_INFO";
		case VK_STRUCTURE_TYPE_COPY_IMAGE_TO_IMAGE_INFO_EXT : return "COPY_IMAGE_TO_IMAGE_INFO";
		case VK_STRUCTURE_TYPE_SUBRESOURCE_HOST_MEMCPY_SIZE_EXT : return "SUBRESOURCE_HOST_MEMCPY_SIZE";
		case VK_STRUCTURE_TYPE_HOST_IMAGE_COPY_DEVICE_PERFORMANCE_QUERY_EXT : return "HOST_IMAGE_COPY_DEVICE_PERFORMANCE_QUERY";
		case VK_STRUCTURE_TYPE_MEMORY_MAP_INFO_KHR : return "MEMORY_MAP_INFO";
		case VK_STRUCTURE_TYPE_MEMORY_UNMAP_INFO_KHR : return "MEMORY_UNMAP_INFO";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_BIAS_CONTROL_FEATURES_EXT : return "PHYSICAL_DEVICE_DEPTH_BIAS_CONTROL_FEATURES";
		case VK_STRUCTURE_TYPE_DEPTH_BIAS_INFO_EXT : return "DEPTH_BIAS_INFO";
		case VK_STRUCTURE_TYPE_DEPTH_BIAS_REPRESENTATION_INFO_EXT : return "DEPTH_BIAS_REPRESENTATION_INFO";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_QUALITY_LEVEL_INFO_KHR : return "PHYSICAL_DEVICE_VIDEO_ENCODE_QUALITY_LEVEL_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUALITY_LEVEL_PROPERTIES_KHR : return "VIDEO_ENCODE_QUALITY_LEVEL_PROPERTIES";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUALITY_LEVEL_INFO_KHR : return "VIDEO_ENCODE_QUALITY_LEVEL_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_SESSION_PARAMETERS_GET_INFO_KHR : return "VIDEO_ENCODE_SESSION_PARAMETERS_GET_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_SESSION_PARAMETERS_FEEDBACK_INFO_KHR : return "VIDEO_ENCODE_SESSION_PARAMETERS_FEEDBACK_INFO";
		...
		case VK_STRUCTURE_TYPE_CUDA_MODULE_CREATE_INFO_NV : return "CUDA_MODULE_CREATE_INFO";
		case VK_STRUCTURE_TYPE_CUDA_FUNCTION_CREATE_INFO_NV : return "CUDA_FUNCTION_CREATE_INFO";
		case VK_STRUCTURE_TYPE_CUDA_LAUNCH_INFO_NV : return "CUDA_LAUNCH_INFO";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUDA_KERNEL_LAUNCH_FEATURES_NV : return "PHYSICAL_DEVICE_CUDA_KERNEL_LAUNCH_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUDA_KERNEL_LAUNCH_PROPERTIES_NV : return "PHYSICAL_DEVICE_CUDA_KERNEL_LAUNCH_PROPERTIES";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAME_BOUNDARY_FEATURES_EXT : return "PHYSICAL_DEVICE_FRAME_BOUNDARY_FEATURES";
		case VK_STRUCTURE_TYPE_FRAME_BOUNDARY_EXT : return "FRAME_BOUNDARY";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TILE_IMAGE_FEATURES_EXT : return "PHYSICAL_DEVICE_SHADER_TILE_IMAGE_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TILE_IMAGE_PROPERTIES_EXT : return "PHYSICAL_DEVICE_SHADER_TILE_IMAGE_PROPERTIES";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DISPLACEMENT_MICROMAP_FEATURES_NV : return "PHYSICAL_DEVICE_DISPLACEMENT_MICROMAP_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DISPLACEMENT_MICROMAP_PROPERTIES_NV : return "PHYSICAL_DEVICE_DISPLACEMENT_MICROMAP_PROPERTIES";
		case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_TRIANGLES_DISPLACEMENT_MICROMAP_NV : return "ACCELERATION_STRUCTURE_TRIANGLES_DISPLACEMENT_MICROMAP";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CLUSTER_CULLING_SHADER_VRS_FEATURES_HUAWEI : return "PHYSICAL_DEVICE_CLUSTER_CULLING_SHADER_VRS_FEATURES";
		...
		case VK_STRUCTURE_TYPE_DEVICE_QUEUE_SHADER_CORE_CONTROL_CREATE_INFO_ARM : return "DEVICE_QUEUE_SHADER_CORE_CONTROL_CREATE_INFO_ARM";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_FEATURES_ARM : return "PHYSICAL_DEVICE_SCHEDULING_CONTROLS_FEATURES_ARM";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_PROPERTIES_ARM : return "PHYSICAL_DEVICE_SCHEDULING_CONTROLS_PROPERTIES_ARM";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RENDER_PASS_STRIPED_FEATURES_ARM : return "PHYSICAL_DEVICE_RENDER_PASS_STRIPED_FEATURES_ARM";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RENDER_PASS_STRIPED_PROPERTIES_ARM : return "PHYSICAL_DEVICE_RENDER_PASS_STRIPED_PROPERTIES_ARM";
		case VK_STRUCTURE_TYPE_RENDER_PASS_STRIPE_BEGIN_INFO_ARM : return "RENDER_PASS_STRIPE_BEGIN_INFO_ARM";
		case VK_STRUCTURE_TYPE_RENDER_PASS_STRIPE_INFO_ARM : return "RENDER_PASS_STRIPE_INFO_ARM";
		case VK_STRUCTURE_TYPE_RENDER_PASS_STRIPE_SUBMIT_INFO_ARM : return "RENDER_PASS_STRIPE_SUBMIT_INFO_ARM";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_COMPUTE_FEATURES_NV : return "PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_COMPUTE_FEATURES";
		case VK_STRUCTURE_TYPE_COMPUTE_PIPELINE_INDIRECT_BUFFER_INFO_NV : return "COMPUTE_PIPELINE_INDIRECT_BUFFER_INFO";
		case VK_STRUCTURE_TYPE_PIPELINE_INDIRECT_DEVICE_ADDRESS_INFO_NV : return "PIPELINE_INDIRECT_DEVICE_ADDRESS_INFO";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_NESTED_COMMAND_BUFFER_FEATURES_EXT : return "PHYSICAL_DEVICE_NESTED_COMMAND_BUFFER_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_NESTED_COMMAND_BUFFER_PROPERTIES_EXT : return "PHYSICAL_DEVICE_NESTED_COMMAND_BUFFER_PROPERTIES";
		case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED_EXT : return "EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_FORMAT_RESOLVE_FEATURES_ANDROID : return "PHYSICAL_DEVICE_EXTERNAL_FORMAT_RESOLVE_FEATURES_ANDROID";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_FORMAT_RESOLVE_PROPERTIES_ANDROID : return "PHYSICAL_DEVICE_EXTERNAL_FORMAT_RESOLVE_PROPERTIES_ANDROID";
		case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_RESOLVE_PROPERTIES_ANDROID : return "ANDROID_HARDWARE_BUFFER_FORMAT_RESOLVE_PROPERTIES_ANDROID";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES_KHR : return "PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES_KHR : return "PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES";
		case VK_STRUCTURE_TYPE_RENDERING_AREA_INFO_KHR : return "RENDERING_AREA_INFO";
		case VK_STRUCTURE_TYPE_DEVICE_IMAGE_SUBRESOURCE_INFO_KHR : return "DEVICE_IMAGE_SUBRESOURCE_INFO";
		case VK_STRUCTURE_TYPE_SUBRESOURCE_LAYOUT_2_KHR : return "SUBRESOURCE_LAYOUT_2";
		case VK_STRUCTURE_TYPE_IMAGE_SUBRESOURCE_2_KHR : return "IMAGE_SUBRESOURCE_2";
		case VK_STRUCTURE_TYPE_PIPELINE_CREATE_FLAGS_2_CREATE_INFO_KHR : return "PIPELINE_CREATE_FLAGS_2_CREATE_INFO";
		case VK_STRUCTURE_TYPE_BUFFER_USAGE_FLAGS_2_CREATE_INFO_KHR : return "BUFFER_USAGE_FLAGS_2_CREATE_INFO";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_POSITION_FETCH_FEATURES_KHR : return "PHYSICAL_DEVICE_RAY_TRACING_POSITION_FETCH_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_OBJECT_FEATURES_EXT : return "PHYSICAL_DEVICE_SHADER_OBJECT_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_OBJECT_PROPERTIES_EXT : return "PHYSICAL_DEVICE_SHADER_OBJECT_PROPERTIES";
		case VK_STRUCTURE_TYPE_SHADER_CREATE_INFO_EXT : return "SHADER_CREATE_INFO";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_SPARSE_ADDRESS_SPACE_FEATURES_NV : return "PHYSICAL_DEVICE_EXTENDED_SPARSE_ADDRESS_SPACE_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_SPARSE_ADDRESS_SPACE_PROPERTIES_NV : return "PHYSICAL_DEVICE_EXTENDED_SPARSE_ADDRESS_SPACE_PROPERTIES";
		...
		case VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT : return "LAYER_SETTINGS_CREATE_INFO";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_FEATURES_EXT : return "PHYSICAL_DEVICE_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_FEATURES";
		case VK_STRUCTURE_TYPE_LATENCY_SLEEP_MODE_INFO_NV : return "LATENCY_SLEEP_MODE_INFO";
		case VK_STRUCTURE_TYPE_LATENCY_SLEEP_INFO_NV : return "LATENCY_SLEEP_INFO";
		case VK_STRUCTURE_TYPE_SET_LATENCY_MARKER_INFO_NV : return "SET_LATENCY_MARKER_INFO";
		case VK_STRUCTURE_TYPE_GET_LATENCY_MARKER_INFO_NV : return "GET_LATENCY_MARKER_INFO";
		case VK_STRUCTURE_TYPE_LATENCY_TIMINGS_FRAME_REPORT_NV : return "LATENCY_TIMINGS_FRAME_REPORT";
		case VK_STRUCTURE_TYPE_LATENCY_SUBMISSION_PRESENT_ID_NV : return "LATENCY_SUBMISSION_PRESENT_ID";
		case VK_STRUCTURE_TYPE_OUT_OF_BAND_QUEUE_TYPE_INFO_NV : return "OUT_OF_BAND_QUEUE_TYPE_INFO";
		case VK_STRUCTURE_TYPE_SWAPCHAIN_LATENCY_CREATE_INFO_NV : return "SWAPCHAIN_LATENCY_CREATE_INFO";
		case VK_STRUCTURE_TYPE_LATENCY_SURFACE_CAPABILITIES_NV : return "LATENCY_SURFACE_CAPABILITIES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_FEATURES_KHR : return "PHYSICAL_DEVICE_COOPERATIVE_MATRIX_FEATURES";
		case VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR : return "COOPERATIVE_MATRIX_PROPERTIES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_PROPERTIES_KHR : return "PHYSICAL_DEVICE_COOPERATIVE_MATRIX_PROPERTIES";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_MAINTENANCE_1_FEATURES_KHR : return "PHYSICAL_DEVICE_VIDEO_MAINTENANCE_1_FEATURES";
		case VK_STRUCTURE_TYPE_VIDEO_INLINE_QUERY_INFO_KHR : return "VIDEO_INLINE_QUERY_INFO";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PER_STAGE_DESCRIPTOR_SET_FEATURES_NV : return "PHYSICAL_DEVICE_PER_STAGE_DESCRIPTOR_SET_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_PROCESSING_2_FEATURES_QCOM : return "PHYSICAL_DEVICE_IMAGE_PROCESSING_2_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_PROCESSING_2_PROPERTIES_QCOM : return "PHYSICAL_DEVICE_IMAGE_PROCESSING_2_PROPERTIES";
		case VK_STRUCTURE_TYPE_SAMPLER_BLOCK_MATCH_WINDOW_CREATE_INFO_QCOM : return "SAMPLER_BLOCK_MATCH_WINDOW_CREATE_INFO";
		case VK_STRUCTURE_TYPE_SAMPLER_CUBIC_WEIGHTS_CREATE_INFO_QCOM : return "SAMPLER_CUBIC_WEIGHTS_CREATE_INFO";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUBIC_WEIGHTS_FEATURES_QCOM : return "PHYSICAL_DEVICE_CUBIC_WEIGHTS_FEATURES";
		case VK_STRUCTURE_TYPE_BLIT_IMAGE_CUBIC_WEIGHTS_INFO_QCOM : return "BLIT_IMAGE_CUBIC_WEIGHTS_INFO";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_YCBCR_DEGAMMA_FEATURES_QCOM : return "PHYSICAL_DEVICE_YCBCR_DEGAMMA_FEATURES";
		case VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_YCBCR_DEGAMMA_CREATE_INFO_QCOM : return "SAMPLER_YCBCR_CONVERSION_YCBCR_DEGAMMA_CREATE_INFO";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUBIC_CLAMP_FEATURES_QCOM : return "PHYSICAL_DEVICE_CUBIC_CLAMP_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ATTACHMENT_FEEDBACK_LOOP_DYNAMIC_STATE_FEATURES_EXT : return "PHYSICAL_DEVICE_ATTACHMENT_FEEDBACK_LOOP_DYNAMIC_STATE_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES_KHR : return "PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES";
		case VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_KHR : return "PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_KHR : return "PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES";
		case VK_STRUCTURE_TYPE_SCREEN_BUFFER_PROPERTIES_QNX : return "SCREEN_BUFFER_PROPERTIES_QNX";
		case VK_STRUCTURE_TYPE_SCREEN_BUFFER_FORMAT_PROPERTIES_QNX : return "SCREEN_BUFFER_FORMAT_PROPERTIES_QNX";
		case VK_STRUCTURE_TYPE_IMPORT_SCREEN_BUFFER_INFO_QNX : return "IMPORT_SCREEN_BUFFER_INFO_QNX";
		case VK_STRUCTURE_TYPE_EXTERNAL_FORMAT_QNX : return "EXTERNAL_FORMAT_QNX";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_SCREEN_BUFFER_FEATURES_QNX : return "PHYSICAL_DEVICE_EXTERNAL_MEMORY_SCREEN_BUFFER_FEATURES_QNX";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LAYERED_DRIVER_PROPERTIES_MSFT : return "PHYSICAL_DEVICE_LAYERED_DRIVER_PROPERTIES_MSFT";
		case VK_STRUCTURE_TYPE_CALIBRATED_TIMESTAMP_INFO_KHR : return "CALIBRATED_TIMESTAMP_INFO";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES_KHR : return "PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_PROPERTIES_KHR : return "PHYSICAL_DEVICE_MAINTENANCE_6_PROPERTIES";
		case VK_STRUCTURE_TYPE_BIND_MEMORY_STATUS_KHR : return "BIND_MEMORY_STATUS";
		case VK_STRUCTURE_TYPE_BIND_DESCRIPTOR_SETS_INFO_KHR : return "BIND_DESCRIPTOR_SETS_INFO";
		case VK_STRUCTURE_TYPE_PUSH_CONSTANTS_INFO_KHR : return "PUSH_CONSTANTS_INFO";
		case VK_STRUCTURE_TYPE_PUSH_DESCRIPTOR_SET_INFO_KHR : return "PUSH_DESCRIPTOR_SET_INFO";
		case VK_STRUCTURE_TYPE_PUSH_DESCRIPTOR_SET_WITH_TEMPLATE_INFO_KHR : return "PUSH_DESCRIPTOR_SET_WITH_TEMPLATE_INFO";
		case VK_STRUCTURE_TYPE_SET_DESCRIPTOR_BUFFER_OFFSETS_INFO_EXT : return "SET_DESCRIPTOR_BUFFER_OFFSETS_INFO";
		case VK_STRUCTURE_TYPE_BIND_DESCRIPTOR_BUFFER_EMBEDDED_SAMPLERS_INFO_EXT : return "BIND_DESCRIPTOR_BUFFER_EMBEDDED_SAMPLERS_INFO";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_POOL_OVERALLOCATION_FEATURES_NV : return "PHYSICAL_DEVICE_DESCRIPTOR_POOL_OVERALLOCATION_FEATURES";
	}
	return "<unknown>";
}
...
ND_ String  VkPipelineBindPointToString (const VkPipelineBindPoint value)
{
	switch ( value )
	{
		...
		case VK_PIPELINE_BIND_POINT_EXECUTION_GRAPH_AMDX : return "EXECUTION_GRAPH_AMDX";
...
ND_ String  VkPipelineStageFlagBits2ToString (const VkPipelineStageFlagBits2 value)
{
	switch ( value )
	{
		...
		case VK_PIPELINE_STAGE_2_SUBPASS_SHADER_BIT_HUAWEI : return "SUBPASS_SHADER";
