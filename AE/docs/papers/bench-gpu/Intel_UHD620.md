...
* FP64 GFLOPS: **96.00**
* Memory v1: 8GB DDR3, 1867MHz, **29.8** GB/s (23 GB/s from tests)
* Memory v2: 8GB LPDDR3 DC 1066MHz, 10-10-10-28, 17 GB/s
* PCI-E 2 5GT/s
...
* FP32 instruction performance: [[2](../GPU_Benchmarks.md#2-fp32-instruction-performance)]
	...
	- Compute is 7% faster than graphics.
...
| VoronoiContourR, 2D           | 1.05M | 7.41 |  7.06 |
| VoronoiContourSparse, 2D      | 1.05M | 7.52 |  7.16 |
| WarleyNoiseFBM, octaves=4     | 262K  | 3.77 | 14.4  |
| IQNoise                       | 262K  | 6.88 | 26.3  |
| VoronoiContourSparse, 3D      | 262K  | 9.89 | 37.7  |
| VoronoiContourR, 3D           | 262K  | 10.1 | 38.5  |
