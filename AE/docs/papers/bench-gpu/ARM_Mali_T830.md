...
```
FLOPS = clock * ALUs * Cores * 8 (?)

1000M * 2 * 1 * 8 = 16 FMA ops per second = 32 GFLOPS
```
...
| VoronoiContourSparse, 2D      | 65K  | 21.8 |  335   |
| VoronoiContourR, 2D           | 65K  | 22.2 |  341   |
| WarleyNoiseFBM, octaves=4     | 65K  | 58   |  892   |
| IQNoise                       | 65K  | 75.6 | 1 160  |
| VoronoiContourSparse, 3D      | 16K  | 23.1 | 1 444  |
| VoronoiContourR, 3D           | 65K  | 97.2 | 1 495  |
