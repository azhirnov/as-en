...
* На NV/AMD/Intel FP32ADD работает в 2 раза быстрее чем FP32FMA, FP32MUL.
* На мобилках FP32ADD, FP32MUL, FP32FMA работают примерно одинаково.
...
**Integer типы**<br/>
Битовые операции и сложение работает за 1x fma. На мобильных архитектурах может быть медленее и доходить до 2-4x fma. На некоторых архитектурах может работать параллельно с float, на других - часть float блоков отключается и теряется производительность.<br/>
