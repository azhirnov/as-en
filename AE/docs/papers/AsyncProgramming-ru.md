...
Но можно написать все проверки в коде, так функция [CreateAsync](https://github.com/azhirnov/as-en/blob/dev/AE/engine/src/threading/TaskSystem/AsyncTask.h#L2172) на этапе компиляции проверяет аргументы и тип корутины на перечисленные выше ошибки.
