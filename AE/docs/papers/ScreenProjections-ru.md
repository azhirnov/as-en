...
* [Panini](https://github.com/azhirnov/as-en/blob/dev/AE/samples/res_editor/_data/scripts/posteffects/Panini.as) - сцена рисуется с перспективной проекцией, затем применяется пост-процесс с Panini проекцией.
