...
# include "platform/Private/VRSessionBase.h"
...
namespace AE::App
{
	...
	class VRSessionOpenVR final : public VRSessionBase
	{
	// types
	public:
	...
	private:
		...
		// variables
		private:
			VRSessionOpenVR &	_vrDev;

		// methods
		public:
			explicit VRRenderSurface (VRSessionOpenVR &vr)											__NE___: _vrDev{vr} {}
	...
	// methods
	public:
		VRSessionOpenVR (VRDeviceListener, IInputActions* dst)					__NE___;
		~VRSessionOpenVR ()														__NE___;
