...
namespace AE::Graphics
{
	...
	public:
		...
		ND_ float2  GetSurfaceSize ()											C_NE___	{ return float2{ _surfaceHeight * _aspect, _surfaceHeight }; }

		ND_ float	AspectRatio ()												C_NE___	{ return _aspect; }	// W / H
		ND_ float2	AspectCorrection ()											C_NE___	{ return float2{ 1.f, _aspect }; }
...
*/
	inline void  SurfaceDimensions::SetDimensions (const float2 &surfaceSizeInPix, float mmPerPixel) __NE___
	{
		...
		_aspect				= surfaceSizeInPix.x * _invSurfaceSize.y;
