...
----
	also see 'DescriptorSetLayoutDesc::UniformOffsets_t'.
=================================================
*/
	NdCx__ uint  EDescriptorType_ToIndex (EDescriptorType type) __NE___
	{
...
=================================================
*/
	NdCx__ bool  EResourceState_HasReadAccess (EResourceState value) __NE___
	{
		return !!(uint(value) & _EResState::AllReadBits);
	}

	NdCx__ bool  EResourceState_HasWriteAccess (EResourceState value) __NE___
	{
		return !!(uint(value) & _EResState::AllWriteBits);
	}

	NdCx__ bool  EResourceState_IsReadOnly (EResourceState value) __NE___
	{
...
=================================================
*/
	NdCx__ bool  EResourceState_HasReadAccess (EResourceState value, EImageAspect mask) __NE___
	{
		uint	result = 0;
	...
	NdCx__ bool  EResourceState_HasWriteAccess (EResourceState value, EImageAspect mask) __NE___
	{
		uint	result = 0;
	...
	NdCx__ bool  EResourceState_IsReadOnly (EResourceState value, EImageAspect mask) __NE___
	{
...
=================================================
*/
	NdCx__ bool  EResourceState_IsSameStates (EResourceState srcState, EResourceState dstState) __NE___
	{
...
*/
	...
	ND_ bool   EPixelFormat_GetPlaneInfo (EPixelFormat fmt, EImageAspect aspect,
								OUT EPixelFormat &planeFormat, OUT POTVec2 &dimScale)	__NE___;
...
=================================================
*/
	NdCxIn bool  EMemoryType_IsNonCoherent (EMemoryType memType) __NE___
	{
		return	AllBits( memType, EMemoryType::HostCached )		and
				NoBits( memType, EMemoryType::HostCoherent );
	}

	NdCxIn bool  EMemoryType_IsHostVisible (EMemoryType memType) __NE___
	{
		return AnyBits( memType, EMemoryType::HostCachedCoherent );
	}

	NdCxIn bool  EMemoryType_IsDeviceLocal (EMemoryType memType) __NE___
	{
