...
namespace AE::Graphics
{
	...
	public:
		...
		private:
			...
			WGLocalSize_t					_computeLocalSize	{UndefinedLocalSize};
	...
	struct PPLNPACK::_ForInternalUsage
	{
	private:
		PPLNPACK const&		_self;

	public:
		_ForInternalUsage (const PPLNPACK &ref) : _self{ref} {}

		ND_ PplnLayouts_t				GetPipelineLayoutIDs ()		C_NE___	{ DRC_SHAREDLOCK( _self._drCheck );  return _self._pplnLayouts; }
		ND_ RenderPassRefs const&		GetRenderPassRefs ()		C_NE___	{ DRC_SHAREDLOCK( _self._drCheck );  return *_self._renderPassRefs; }
		ND_ SamplerRefs_t const&		GetSamplerRefs ()			C_NE___	{ DRC_SHAREDLOCK( _self._drCheck );  return *_self._samplerRefs; }
		ND_ DSLayouts_t					GetDescriptorSetLayouts ()	C_NE___	{ DRC_SHAREDLOCK( _self._drCheck );  return _self._dsLayouts; }
		ND_ FeatureNames_t const&		GetUnsupportedFS ()			C_NE___	{ DRC_SHAREDLOCK( _self._drCheck );  return *_self._unsupportedFS; }
		GFX_DBG_ONLY( ND_ auto const&	GetAllFS ()					C_NE___	{ DRC_SHAREDLOCK( _self._drCheck );  return *_self._allFeatureSets; })
	};
