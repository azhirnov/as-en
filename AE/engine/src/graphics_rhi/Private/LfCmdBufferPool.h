...
namespace AE::Graphics
{
	...
	// methods
	public:
		__Cx__ CmdBufExeIndex ()										__NE___ : CmdBufExeIndex{ 0, EMode::FrontToBack } {}
		__Cx__ CmdBufExeIndex (CmdBufExeIndex &&)						__NE___	= default;
		__Cx__ CmdBufExeIndex (const CmdBufExeIndex &)					__NE___	= default;
		__Cx__ CmdBufExeIndex (uint idx, EMode mode)					__NE___	: _packed{ uint(mode) | (idx << 8) } {}

		__Cx__ CmdBufExeIndex&  operator = (const CmdBufExeIndex &)		__NE___ = default;
		__Cx__ CmdBufExeIndex&  operator = (CmdBufExeIndex &&)			__NE___ = default;
	...
	public:
		...
		StaticAssert( not IsSame< NativeCmdBuffer_t, BakedCommands_t >);
