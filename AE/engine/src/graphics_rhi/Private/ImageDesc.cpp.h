...
*/
	void  ImageDesc::Validate () __NE___
	{
		...
		if ( AllBits( options, EImageOpt::LossyRTCompression ) and
			 NoBits( usage, EImageUsage::ColorAttachment | EImageUsage::DepthStencilAttachment ))
			options &= ~EImageOpt::LossyRTCompression;
...
*/
	ImageViewDesc::ImageViewDesc (EImage			viewType,
		...
		baseMipmap{ baseMipmap },	mipmapCount{ MipmapCount_t(mipmapCount) },
...
*/
	ImageViewDesc::ImageViewDesc (const ImageDesc &desc) __NE___ :
		...
		baseMipmap{},				mipmapCount{ desc.mipLevels },
		baseLayer{},				layerCount{ desc.arrayLayers },
