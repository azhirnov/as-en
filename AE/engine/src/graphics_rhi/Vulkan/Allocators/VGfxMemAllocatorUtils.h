...
namespace AE::Graphics
{
	...
	struct VGfxMemAllocatorUtils : Noninstanceable
	{
		struct Key
		{
			...
			ND_ bool  IsShaderAddress ()					C_NE___	{ return HasBit< _ShaderAddrBit	>( value ); }
			ND_ bool  IsImage ()							C_NE___	{ return HasBit< _IsImageBit	>( value ); }
			ND_ bool  IsMappedMemory ()						C_NE___	{ return HasBit< _MappedMemBit	>( value ); }
		};
	};
