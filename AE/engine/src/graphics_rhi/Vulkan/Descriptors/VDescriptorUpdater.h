...
namespace AE::Graphics
{
	...
	public:
		...
		bool  BindRayTracingPartitionedScene (UniformName::Ref, VkDeviceAddress scene, uint elementIndex = 0)									__NE___;
		bool  BindRayTracingPartitionedScenes (UniformName::Ref, ArrayView<VkDeviceAddress> scenes, uint firstIndex = 0)						__NE___;

		bool  BindRayTracingPartitionedScene (UniformName::Ref, DeviceAddress scene, uint elementIndex = 0)										__NE_OV;
		bool  BindRayTracingPartitionedScene (UniformName::Ref, BufferID buffer, Bytes offset = 0_b, uint elementIndex = 0)						__NE_OV;

		uint  RayTracingSceneCount (UniformName::Ref)																							C_NE_OV;
		uint  RayTracingPartitionedSceneCount (UniformName::Ref)																				C_NE_OV;
	...
	private:
		...
		template <typename T>
		bool  _BindRayTracingPartitionedScenes (UniformName::Ref, ArrayView<T> scenes, uint firstIndex)											__NE___;
	};
