...
namespace AE::Graphics
{
	...
	public:
		...
		struct DeviceCreateInfo
		{
			...
			void*					disableFeaturesUserData	= null;
		...
		using MemoryReport_t = Function< void (AnyTypeCRef) >;	// VkDeviceMemoryReportCallbackDataEXT
	...
	public:
	  ...
	  // LowLevel //
		...
		ND_ bool  IsEnabledDebugCallback ()															C_NE___;
			...
			bool  CreateMemoryReport (MemoryReport_t callback = Default)							__NE___;
