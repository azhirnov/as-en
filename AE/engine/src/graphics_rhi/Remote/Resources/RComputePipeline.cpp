...
=================================================
*/
	bool  RComputePipeline::Create (ResourceManager &resMngr, const CreateInfo &ci) __NE___
	{
		DRC_EXLOCK( _drCheck );
...
=================================================
*/
	void  RComputePipeline::Destroy (ResourceManager &resMngr) __NE___
	{
		DRC_EXLOCK( _drCheck );
...
=================================================
*/
	bool  RComputePipeline::ParseShaderAsserts (const void* ptr, Bytes maxSize, ShaderDebugger::ELogFormat format, OUT Array<String> &result) C_NE___
	{
		DRC_SHAREDLOCK( _drCheck );
