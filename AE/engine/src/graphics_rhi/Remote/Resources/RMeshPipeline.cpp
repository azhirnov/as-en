...
=================================================
*/
	bool  RMeshPipeline::Create (ResourceManager &resMngr, const CreateInfo &ci) __NE___
	{
		DRC_EXLOCK( _drCheck );
...
=================================================
*/
	void  RMeshPipeline::Destroy (ResourceManager &resMngr) __NE___
	{
		DRC_EXLOCK( _drCheck );
...
=================================================
*/
	bool  RMeshPipeline::ParseShaderAsserts (const void* ptr, Bytes maxSize, ShaderDebugger::ELogFormat format, OUT Array<String> &result) C_NE___
	{
		result.clear();
		DRC_SHAREDLOCK( _drCheck );
