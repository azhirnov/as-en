...
=================================================
*/
	void  RRayTracingContext::TraceRaysIndirectAddress (const RTShaderBindingTable &sbt, DeviceAddress address) __Th___
	{
...
=================================================
*/
	void  RRayTracingContext::TraceRaysIndirectAddress2 (DeviceAddress address) __Th___
	{
