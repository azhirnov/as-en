...
{
	StaticAssert( sizeof(ImageSubresourceRange) == 8 );
	StaticAssert( sizeof(ImageSubresourceLayers) == 6 );
...
//-----------------------------------------------------------------------------
	...
	StaticAssert( sizeof(RenderTechDesc) == 18 );
	#define Ser_RenderTechDesc( _desc_ )\
		_desc_.taskLocalSize, _desc_.meshLocalSize, _desc_.computeLocalSize
	...
	DECL_SERIALIZER( ResMngr_LoadRenderTech,				packId, name, Ser_RenderTechDesc( desc ), cacheId )
...
//-----------------------------------------------------------------------------
	...
	StaticAssert( sizeof(UploadImageDesc) == 32 );
