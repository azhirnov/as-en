...
#include "graphics_rhi/RenderGraph/RGCommon.h"
...
namespace AE::RG::_hidden_
{
	...
	// types
		...
		static constexpr Value_t	_IndexMask	= Base::ToBitMask<Value_t>( CT_SizeOfInBits<Index_t> );
		static constexpr Value_t	_GenMask	= Base::ToBitMask<Value_t>( CT_SizeOfInBits<Generation_t> );
