...
=================================================
*/
	NdCxIn EResourceState  operator | (EResourceState lhs, EResourceState rhs) __NE___
	{
		DBG_CHECK_MSG_Cx( uint(AnyBits( lhs, _EResState::AccessMask )) + uint(AnyBits( rhs, _EResState::AccessMask )) < 2,
	...
	__CxIn EResourceState&  operator |= (EResourceState &lhs, EResourceState rhs) __NE___
	{
		return (lhs = (lhs | rhs));
	}
	...
	NdCxIn EResourceState  operator ~ (EResourceState x) __NE___
	{
		return EResourceState(~uint(x));
	}


	NdCxIn _EResState::EState  ToEResState (EResourceState state) __NE___
	{
