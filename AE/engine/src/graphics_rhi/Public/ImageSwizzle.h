...
namespace AE::Graphics
{
	...
	// methods
	public:
		__Cx__ ImageSwizzle ()																__NE___ {}
		explicit ImageSwizzle (const uint4 &comp)											__NE___;

		NdCx__ uint		Get ()																C_NE___	{ return _value; }
		NdCx__ bool		IsDefault ()														C_NE___	{ return _value == ImageSwizzle().Get(); }
		NdCx__ bool		IsUndefined ()														C_NE___	{ return _value == 0; }

		Nd____ uint4	ToVec ()															C_NE___;

		NdCx__ bool		operator == (const ImageSwizzle &rhs)								C_NE___	{ return _value == rhs._value; }
		NdCx__ bool		operator >  (const ImageSwizzle &rhs)								C_NE___	{ return _value >  rhs._value; }

		NdCx__ static ImageSwizzle  FromString (const char* str, const usize len)			__NE___;
		NdCx__ static ImageSwizzle  FromString (StringView str)								__NE___	{ return FromString( str.data(), str.size() ); }
		NdCx__ static ImageSwizzle  Undefined ()											__NE___	{ ImageSwizzle tmp;  tmp._value = 0;  return tmp; }
	...
	private:
		__Cx__ static uint  _CharToValue (char c)											__NE___;
	};
...
=================================================
*/
	__CxIn uint  ImageSwizzle::_CharToValue (char c) __NE___
	{
		return	c == 'r' or c == 'R'	? 1 :
				c == 'g' or c == 'G'	? 2 :
				c == 'b' or c == 'B'	? 3 :
...
=================================================
*/
	__CxIn ImageSwizzle  ImageSwizzle::FromString (const char* str, const usize len) __NE___
	{
		ASSERT_Cx( len <= 4 );
