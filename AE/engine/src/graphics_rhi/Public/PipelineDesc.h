...
namespace AE::Graphics
{
	...
	//
	// Render Technique description
	//
	struct RenderTechDesc
	{
		// Set default workgroup size for specialized pipelines at load time.
		// For compute shader number of threads should be at least 2-4x of threads in subgroup.
		static constexpr WGLocalSize_t::value_type	UndefinedLocalSize = UMax;

		WGLocalSize_t		taskLocalSize		{UndefinedLocalSize};
		WGLocalSize_t		meshLocalSize		{UndefinedLocalSize};
		WGLocalSize_t		computeLocalSize	{UndefinedLocalSize};
	};
	...
	struct BasePipelineDesc
	{
		...
		static constexpr WGLocalSize_t::value_type	UndefinedLocalSize	= UMax;
		static constexpr WGLocalSize_t::value_type	LoadTimeLocalSize	= UndefinedLocalSize-1;		// will be used size from 'RenderTechDesc'
	...
	// types
		...
		struct VertexBuffer
		{
			...
			Bytes16u						stride;
			uint							divisor		= 0;			// non-zero if enabled
		};
	...
	{
	// variables
		WGLocalSize_t		localSize		{UndefinedLocalSize};
		ushort				subgroupSize	= 0;		// requires 'subgroupSizeControl' feature
	...
	// variables
		CompatRenderPassName::Optimized_t	renderPass;
		SubpassName::Optimized_t			subpass;
		WGLocalSize2_t						localSize	{UndefinedLocalSize};
