...
namespace AE::Graphics
{
	...
	enum class EMemoryType : ubyte
	{
		...
		All					= ((_Last-1) << 1) - 1,
		HostCachedCoherent	= HostCoherent | HostCached,			// may completely match with 'HostCached'
	...
	{
		sRGB_nonlinear,				// 8 bit
		Display_P3_nonlinear,		// 8 bit
		Extended_sRGB_linear,		// scRGB, backward compatible with sRGB, {1,1,1} = 80 nit, {125.0} = 10'000 nit.
		Display_P3_linear,			// sRGB curve with extended range
		DCI_P3_nonlinear,			// 8 bit
		BT709_linear,				// 8 bit
		BT709_nonlinear,			// 8 bit
		BT2020_linear,				// 16 bit
		HDR10_ST2084,				// 10 bit, max 4'000 nit.
		DolbyVision,				// 12 bit, max 12'000 nit.
		HDR10_HLG,					// 10 bit
		AdobeRGB_linear,
		AdobeRGB_nonlinear,
