...
=================================================
*/
	void  ArmProfiler::Sample (OUT Counters_t &result, INOUT float &invdt) C_NE___
	{
		result.clear();
...
=================================================
*/
	void  ArmProfiler::Sample (OUT Counters_t &outCounters, INOUT float &invdt) C_NE___
	{
		outCounters.clear();
		Unused( invdt );	// keep current
...
namespace AE::Profiler
{
	...
	void  ArmProfiler::Sample (OUT Counters_t &result, INOUT float &invdt)	C_NE___	{ if (_impl) return _impl->client->Sample( OUT result, INOUT invdt ); }
