...
*/
    CpuArchInfo::CpuArchInfo ()
    {
        ...
        // CPU cache info
        {
            ...
            cache.L1_Inst.size          = Byte32u{uint(::getauxval( AT_L1I_CACHESIZE ))};
