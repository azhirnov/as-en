...
del "temp.7z"
powershell -Command "(New-Object Net.WebClient).DownloadFile('https://sdk.lunarg.com/sdk/download/1.4.309.0/windows/VulkanRT-1.4.309.0-Components.zip', 'temp.7z')"
...
copy /Y "temp\vk-rt\VulkanRT-1.4.309.0-Components\x64\vulkan-1.dll" "..\..\..\..\..\AE-Bin\external\win-x64\lavapipe\vulkan-1.dll"
rmdir /Q /S "temp"
rmdir /Q /S "build"
pause
