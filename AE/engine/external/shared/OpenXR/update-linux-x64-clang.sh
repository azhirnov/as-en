echo "update 'OpenXR'..."
rm -rf "build"
rm -rf "../../../../../AE-Bin/external/linux-x64-clang20/OpenXR"
rm -rf "temp"
mkdir "build"
...
cmake -S temp -B build -G "Unix Makefiles" -DAE_ENABLE_COMPILER_WARNINGS=OFF -DCMAKE_BUILD_TYPE=Release -DAE_SIMD_SSE=20 -DAE_SIMD_AES=0 -DCMAKE_INSTALL_PREFIX="../../../../../AE-Bin/external/linux-x64-clang20/OpenXR"  || pauseOnError
