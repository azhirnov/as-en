...
rmdir /Q /S "temp"
mkdir "build"
git clone --branch "sdk-1.3.261.1" "..\..\..\..\..\3party\glslang" "temp"
git clone --branch "sdk-1.3.261.1" "..\..\..\..\..\3party\SPIRV-Tools" "temp/External/spirv-tools"
git clone --branch "sdk-1.3.261.1" "..\..\..\..\..\3party\SPIRV-Headers" "temp/External/spirv-tools/external/spirv-headers"
