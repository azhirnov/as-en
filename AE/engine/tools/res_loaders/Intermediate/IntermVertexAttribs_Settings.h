...
=================================================
*/
    IntermVertexAttribs::Setter&  IntermVertexAttribs::Setter::AddBuffer (Bytes stride, EVertexInputRate rate)
    {
        return AddBuffer( Name_t{}, stride, rate );
    }

    IntermVertexAttribs::Setter&  IntermVertexAttribs::Setter::AddBuffer (const Name_t &bufferId, Bytes stride, EVertexInputRate rate)
    {
...
=================================================
*/
    IntermVertexAttribs::Setter&  IntermVertexAttribs::Setter::AddVertex (const Name_t &id, EVertexType type, Bytes offset)
    {
