...
ND_ static TIntermAggregate*  RecordFragmentShaderInfo (const TSourceLoc &loc, DebugInfo &dbgInfo)
{
	...
	if ( auto*  fragcoord = dbgInfo.GetCachedSymbolNode( "gl_FragCoord" ))
	{
