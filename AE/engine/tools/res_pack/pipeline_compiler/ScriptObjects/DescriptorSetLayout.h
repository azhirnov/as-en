...
namespace AE::PipelineCompiler
{
	...
	public:
		...
		void  AddCombinedImage_ImmutableSampler (EShaderStages, const String &name, EImageType, EResourceState, const ArraySize &, const String &samplerName)__Th___;
		void  AddCombinedImage_ImmutableSampler (EShaderStages, const String &, EImageType, EResourceState, const ArraySize &, ArrayView<String> samplerNames)__Th___;
