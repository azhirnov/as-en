...
struct Sampler
{
	...
	void  NormCoordinates (bool norm);
...
struct RayTracingShaderBinding
{
	...
	void  HitGroupStride (uint stride);
	...
	void  BindMiss (const string & groupName, const MissIndex & missIndex);
