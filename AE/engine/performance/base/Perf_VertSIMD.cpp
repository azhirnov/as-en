...
//-----------------------------------------------------------------------------
	...
	{
		IntervalProfiler	profiler{ "Vertical SIMD, Dot test, "s << name, IntervalProfiler::EFlags::SortByTime };
	...
	{
		IntervalProfiler	profiler{ "Vertical SIMD, Cross test, "s << name, IntervalProfiler::EFlags::SortByTime };
