...
void ASmain ()
{
	...
	{
		RC<Shader>	rg	= Shader();
		rg.file		= "rtrace1.glsl";		// [src](https://github.com/azhirnov/as-en/blob/dev/AE/engine/tests/graphics_rhi/RenderGraph/shaders/rtrace1.glsl)
	...
	{
		RC<Shader>	rm	= Shader();
		rm.file		= "rtrace1.glsl";		// [src](https://github.com/azhirnov/as-en/blob/dev/AE/engine/tests/graphics_rhi/RenderGraph/shaders/rtrace1.glsl)
	...
	// triangle hit groups
	{
		...
		rch.file	= "rtrace1.glsl";		// [src](https://github.com/azhirnov/as-en/blob/dev/AE/engine/tests/graphics_rhi/RenderGraph/shaders/rtrace1.glsl)
