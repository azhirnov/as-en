...
void ASmain ()
{
	...
	{
		RC<Shader>	ms	= Shader();
		ms.file		= "draw_mesh1.glsl";		// [src](https://github.com/azhirnov/as-en/blob/dev/AE/engine/tests/graphics_rhi/RenderGraph/shaders/draw_mesh1.glsl)
	...
	{
		RC<Shader>	fs	= Shader();
		fs.file		= "draw_mesh1.glsl";		// [src](https://github.com/azhirnov/as-en/blob/dev/AE/engine/tests/graphics_rhi/RenderGraph/shaders/draw_mesh1.glsl)
