...
void PerDrawSRPipeline ()
{
	...
	{
		RC<Shader>	vs	= Shader();
		vs.file		= "shadingrate.glsl";			// [src](https://github.com/azhirnov/as-en/blob/dev/AE/engine/tests/graphics_rhi/RenderGraph/shaders/shadingrate.glsl)
	...
	{
		RC<Shader>	fs	= Shader();
		fs.file		= "shadingrate.glsl";			// [src](https://github.com/azhirnov/as-en/blob/dev/AE/engine/tests/graphics_rhi/RenderGraph/shaders/shadingrate.glsl)
