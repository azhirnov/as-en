...
void ASmain ()
{
...

	{
		...
		ds.CombinedImage( EShaderStages::Fragment, "un_YcbcrTexture", EImageType::Float_2D, "NearestClamp|ycbcr|G8_B8R8_420_UNorm" );
	}{
...

	{
		...
		{
			RC<Shader>	vs = Shader();
			vs.file		= "ycbcr.glsl";	// [src](https://github.com/azhirnov/as-en/blob/dev/AE/engine/tests/graphics_rhi/RenderGraph/shaders/ycbcr.glsl)
			vs.options	= EShaderOpt::Optimize;
			ppln.SetVertexShader( vs );
		}
		{
			RC<Shader>	fs = Shader();
			fs.file		= "ycbcr.glsl";	// [src](https://github.com/azhirnov/as-en/blob/dev/AE/engine/tests/graphics_rhi/RenderGraph/shaders/ycbcr.glsl)
