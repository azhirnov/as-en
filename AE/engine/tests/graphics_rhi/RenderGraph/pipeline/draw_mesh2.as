...
void ASmain ()
{
	...
	{
		RC<Shader>	ts	= Shader();
		ts.file		= "draw_mesh2.glsl";		// [src](https://github.com/azhirnov/as-en/blob/dev/AE/engine/tests/graphics_rhi/RenderGraph/shaders/draw_mesh2.glsl)
		...
		RC<Shader>	ms	= Shader();
		ms.file		= "draw_mesh2.glsl";		// [src](https://github.com/azhirnov/as-en/blob/dev/AE/engine/tests/graphics_rhi/RenderGraph/shaders/draw_mesh2.glsl)
		...
		RC<Shader>	fs	= Shader();
		fs.file		= "draw_mesh2.glsl";		// [src](https://github.com/azhirnov/as-en/blob/dev/AE/engine/tests/graphics_rhi/RenderGraph/shaders/draw_mesh2.glsl)
