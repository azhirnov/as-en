...
/*
	Generate random BC7 image and decode it using software and hardware algorithms.
*/
...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		const EPixelFormat	comp_fmt	= EPixelFormat::BC7_RGBA8_UNorm;
...
//-----------------------------------------------------------------------------
	...
	float4  Decode (int2 coord)
	{
		...
		float4	col		= float4(DecodeBC7( block, coord & 3 ));
		return	col;
	}
