...
/*
	Generate random BC4 image and decode it using software and hardware algorithms.
*/
...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		const EPixelFormat	comp_fmt	= EPixelFormat::BC4_R8_UNorm;
		const EPixelFormat	comp2_fmt	= EPixelFormat::BC4_R8_SNorm;
...
//-----------------------------------------------------------------------------
	...
	void  Main ()
	{
		...
		float4	col1	= DecodeBC4U( block, coord & 3 );
		float4	col2	= DecodeBC4S( block, coord & 3 );	col2.r = ToUNorm( col2.r );
