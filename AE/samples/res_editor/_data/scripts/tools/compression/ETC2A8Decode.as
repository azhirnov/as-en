...
/*
	Generate random ETC2_RGBA image and decode it using software and hardware algorithms.
*/
...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		const EPixelFormat	comp_fmt	= EPixelFormat::ETC2_RGBA8_UNorm;
...
//-----------------------------------------------------------------------------
	...
	float4  Decode (int2 coord)
	{
		...
		float4	col		= float4(DecodeETC2_EAC( block, coord & 3 ));
		return	col;
	}
