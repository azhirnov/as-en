...
/*
	Generate random ETC2 image and decode it using software and hardware algorithms.
*/
...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		const EPixelFormat	comp_fmt	= EPixelFormat::ETC2_RGB8_A1_UNorm;
...
//-----------------------------------------------------------------------------
	...
	float4  Decode (int2 coord)
	{
		...
		float4	col		= float4(DecodeETC2A1( block, coord & 3 ));
		return	col;
	}
