...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		//	draw.AddPipelines( "perf/MaterialDepthBuffer-HiPerf" );		// [folder](https://github.com/azhirnov/as-en/blob/dev/AE/samples/res_editor/_data/pipelines/perf/MaterialDepthBuffer-HiPerf)
		//	draw.AddPipelines( "perf/MaterialDepthBuffer-MedPerf" );	// [folder](https://github.com/azhirnov/as-en/blob/dev/AE/samples/res_editor/_data/pipelines/perf/MaterialDepthBuffer-MedPerf)
			draw.AddPipelines( "perf/MaterialDepthBuffer-LowPerf" );	// [folder](https://github.com/azhirnov/as-en/blob/dev/AE/samples/res_editor/_data/pipelines/perf/MaterialDepthBuffer-LowPerf)
		}
