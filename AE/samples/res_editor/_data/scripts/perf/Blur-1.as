	...
	//	const EPixelFormat	hdr_fmt	= EPixelFormat::R11G11B10F;	// HDR on mobile
		...
		// render loop
		{
			...
			// Downscale
			{
				...
				RC<Postprocess>		pass = Postprocess( "", "DOWNSAMPLE_PASS" );
				pass.ArgIn( "un_Emission",	down_rt1,		Sampler_LinearClamp );
				...
				RC<Postprocess>		pass = Postprocess( "", "DOWNSAMPLE_PASS" );
				pass.ArgIn( "un_Emission",	down_rt2,		Sampler_LinearClamp );
				...
				RC<Postprocess>		pass = Postprocess( "", "DOWNSAMPLE_PASS" );
				pass.ArgIn( "un_Emission",	down_rt3,		Sampler_LinearClamp );
				...
				RC<Postprocess>		pass = Postprocess( "", "DOWNSAMPLE_PASS" );
				pass.ArgIn( "un_Emission",	down_rt4,		Sampler_LinearClamp );
				...
				RC<Postprocess>		pass = Postprocess( "", "DOWNSAMPLE_PASS" );
				pass.ArgIn( "un_Emission",	down_rt5,		Sampler_LinearClamp );
...
//-------------------------------------------------------------------------------------------------
	...
	void  Main ()
	{
		out_Color = Blur5Ref( un_Emission, int2(gl.FragCoord.xy)*2 );
	}
