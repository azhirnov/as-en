...
//-----------------------------------------------------------------------------
	...
	bool  IsVisible (uint idx)
	{
		...
		// frustum culling
		if ( ! Frustum_TestSphere( un_PerPass.camera.frustum, obj.position - un_PerPass.camera.pos, sphere_radius ))
			return false;
		...
		float4	aabb = ProjectSphere( sphere_center, sphere_radius, un_PerPass.camera.proj[0][0], un_PerPass.camera.proj[1][1] );
