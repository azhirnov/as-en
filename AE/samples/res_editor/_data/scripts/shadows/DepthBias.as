...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		...
		// render loop
		{
			...
			pass.AddPipeline( "samples/LowPolyTrees/SM.as" );	// [src](https://github.com/azhirnov/as-en/blob/dev/AE/samples/res_editor/_data/pipelines/samples/LowPolyTrees/SM.as)
			...
			pass.AddPipeline( "samples/LowPolyTrees/SM2.as" );	// [src](https://github.com/azhirnov/as-en/blob/dev/AE/samples/res_editor/_data/pipelines/samples/LowPolyTrees/SM2.as)
			pass.Output( "out_Color",		sm_col,		RGBA32f(0.0) );
			pass.Output(					sm,			DepthStencil(1.0, 0) );
			pass.ArgIn(  "un_Params",		cbuf );
