...
//-----------------------------------------------------------------------------
	...
	void ASmain ()
	{
		RC<GraphicsPipeline>	ppln = GraphicsPipeline( "ui.image_rgba" );
		...
		// specialization
		{
			RC<GraphicsPipelineSpec>	spec = ppln.AddSpecialization( "ui.image_rgba" );
...
//-----------------------------------------------------------------------------
	...
	void Main ()
	{
		out_Color = gl.texture.Sample( un_ImageRGBA, In.uv ) * In.color;
	}
