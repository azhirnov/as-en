...
ND_ String  VkPipelineStageFlagBitsToString (const VkPipelineStageFlagBits value)
{
	switch ( value )
	{
		...
		case VK_PIPELINE_STAGE_TASK_SHADER_BIT_NV : return "TASK_SHADER_BIT_NV";
		case VK_PIPELINE_STAGE_MESH_SHADER_BIT_NV : return "MESH_SHADER_BIT_NV";
		...
		case VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_NV : return "COMMAND_PREPROCESS_BIT_NV";
	}
	return "<unknown>";
}
...
ND_ String  VkAccessFlagBitsToString (const VkAccessFlagBits value)
{
	switch ( value )
	{
		case VK_ACCESS_INDIRECT_COMMAND_READ_BIT : return "IRECT_COMMAND_READ";
		case VK_ACCESS_INDEX_READ_BIT : return "EX_READ";
		case VK_ACCESS_VERTEX_ATTRIBUTE_READ_BIT : return "TEX_ATTRIBUTE_READ";
		case VK_ACCESS_UNIFORM_READ_BIT : return "FORM_READ";
		case VK_ACCESS_INPUT_ATTACHMENT_READ_BIT : return "UT_ATTACHMENT_READ";
		case VK_ACCESS_SHADER_READ_BIT : return "DER_READ";
		case VK_ACCESS_SHADER_WRITE_BIT : return "DER_WRITE";
		case VK_ACCESS_COLOR_ATTACHMENT_READ_BIT : return "OR_ATTACHMENT_READ";
		case VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT : return "OR_ATTACHMENT_WRITE";
		case VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT : return "TH_STENCIL_ATTACHMENT_READ";
		case VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT : return "TH_STENCIL_ATTACHMENT_WRITE";
		case VK_ACCESS_TRANSFER_READ_BIT : return "NSFER_READ";
		case VK_ACCESS_TRANSFER_WRITE_BIT : return "NSFER_WRITE";
		case VK_ACCESS_HOST_READ_BIT : return "T_READ";
		case VK_ACCESS_HOST_WRITE_BIT : return "T_WRITE";
		case VK_ACCESS_MEMORY_READ_BIT : return "ORY_READ";
		case VK_ACCESS_MEMORY_WRITE_BIT : return "ORY_WRITE";
		case VK_ACCESS_NONE : return "E";
		case VK_ACCESS_TRANSFORM_FEEDBACK_WRITE_BIT_EXT : return "NSFORM_FEEDBACK_WRITE";
		case VK_ACCESS_TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT : return "NSFORM_FEEDBACK_COUNTER_READ";
		case VK_ACCESS_TRANSFORM_FEEDBACK_COUNTER_WRITE_BIT_EXT : return "NSFORM_FEEDBACK_COUNTER_WRITE";
		case VK_ACCESS_CONDITIONAL_RENDERING_READ_BIT_EXT : return "DITIONAL_RENDERING_READ";
		case VK_ACCESS_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT : return "OR_ATTACHMENT_READ_NONCOHERENT";
		case VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_KHR : return "ELERATION_STRUCTURE_READ";
		case VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_KHR : return "ELERATION_STRUCTURE_WRITE";
		case VK_ACCESS_FRAGMENT_DENSITY_MAP_READ_BIT_EXT : return "GMENT_DENSITY_MAP_READ";
		case VK_ACCESS_FRAGMENT_SHADING_RATE_ATTACHMENT_READ_BIT_KHR : return "GMENT_SHADING_RATE_ATTACHMENT_READ";
		case VK_ACCESS_COMMAND_PREPROCESS_READ_BIT_NV : return "MAND_PREPROCESS_READ_BIT_NV";
		case VK_ACCESS_COMMAND_PREPROCESS_WRITE_BIT_NV : return "MAND_PREPROCESS_WRITE_BIT_NV";
	}
	return "<unknown>";
}
...
ND_ String  VkStructureTypeToString (const VkStructureType value)
{
	switch ( value )
	{
		...
		case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_RASTERIZATION_ORDER_AMD : return "PIPELINE_RASTERIZATION_STATE_RASTERIZATION_ORDER_AMD";
		...
		case VK_STRUCTURE_TYPE_VIDEO_PROFILE_KHR : return "VIDEO_PROFILE";
		case VK_STRUCTURE_TYPE_VIDEO_CAPABILITIES_KHR : return "VIDEO_CAPABILITIES";
		case VK_STRUCTURE_TYPE_VIDEO_PICTURE_RESOURCE_KHR : return "VIDEO_PICTURE_RESOURCE";
		case VK_STRUCTURE_TYPE_VIDEO_GET_MEMORY_PROPERTIES_KHR : return "VIDEO_GET_MEMORY_PROPERTIES";
		case VK_STRUCTURE_TYPE_VIDEO_BIND_MEMORY_KHR : return "VIDEO_BIND_MEMORY";
		...
		case VK_STRUCTURE_TYPE_VIDEO_REFERENCE_SLOT_KHR : return "VIDEO_REFERENCE_SLOT";
		case VK_STRUCTURE_TYPE_VIDEO_QUEUE_FAMILY_PROPERTIES_2_KHR : return "VIDEO_QUEUE_FAMILY_PROPERTIES_2";
		case VK_STRUCTURE_TYPE_VIDEO_PROFILES_KHR : return "VIDEO_PROFILES";
		...
		case VK_STRUCTURE_TYPE_QUEUE_FAMILY_QUERY_RESULT_STATUS_PROPERTIES_2_KHR : return "QUEUE_FAMILY_QUERY_RESULT_STATUS_PROPERTIES_2";
		...
		case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_IMAGE_CREATE_INFO_NV : return "DEDICATED_ALLOCATION_IMAGE_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_BUFFER_CREATE_INFO_NV : return "DEDICATED_ALLOCATION_BUFFER_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_MEMORY_ALLOCATE_INFO_NV : return "DEDICATED_ALLOCATION_MEMORY_ALLOCATE_INFO_NV";
		...
		case VK_STRUCTURE_TYPE_CU_MODULE_CREATE_INFO_NVX : return "CU_MODULE_CREATE_INFO_NVX";
		case VK_STRUCTURE_TYPE_CU_FUNCTION_CREATE_INFO_NVX : return "CU_FUNCTION_CREATE_INFO_NVX";
		case VK_STRUCTURE_TYPE_CU_LAUNCH_INFO_NVX : return "CU_LAUNCH_INFO_NVX";
		case VK_STRUCTURE_TYPE_IMAGE_VIEW_HANDLE_INFO_NVX : return "IMAGE_VIEW_HANDLE_INFO_NVX";
		case VK_STRUCTURE_TYPE_IMAGE_VIEW_ADDRESS_PROPERTIES_NVX : return "IMAGE_VIEW_ADDRESS_PROPERTIES_NVX";
		...
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_NALU_SLICE_EXT : return "VIDEO_ENCODE_H264_NALU_SLICE";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_EMIT_PICTURE_PARAMETERS_EXT : return "VIDEO_ENCODE_H264_EMIT_PICTURE_PARAMETERS";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_PROFILE_EXT : return "VIDEO_ENCODE_H264_PROFILE";
		...
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_REFERENCE_LISTS_EXT : return "VIDEO_ENCODE_H264_REFERENCE_LISTS";
		...
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_NALU_SLICE_SEGMENT_EXT : return "VIDEO_ENCODE_H265_NALU_SLICE_SEGMENT";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_EMIT_PICTURE_PARAMETERS_EXT : return "VIDEO_ENCODE_H265_EMIT_PICTURE_PARAMETERS";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_PROFILE_EXT : return "VIDEO_ENCODE_H265_PROFILE";
		case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_REFERENCE_LISTS_EXT : return "VIDEO_ENCODE_H265_REFERENCE_LISTS";
		...
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_CAPABILITIES_EXT : return "VIDEO_DECODE_H264_CAPABILITIES";
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_PICTURE_INFO_EXT : return "VIDEO_DECODE_H264_PICTURE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_MVC_EXT : return "VIDEO_DECODE_H264_MVC";
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_PROFILE_EXT : return "VIDEO_DECODE_H264_PROFILE";
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_SESSION_PARAMETERS_CREATE_INFO_EXT : return "VIDEO_DECODE_H264_SESSION_PARAMETERS_CREATE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_SESSION_PARAMETERS_ADD_INFO_EXT : return "VIDEO_DECODE_H264_SESSION_PARAMETERS_ADD_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_DPB_SLOT_INFO_EXT : return "VIDEO_DECODE_H264_DPB_SLOT_INFO";
		case VK_STRUCTURE_TYPE_TEXTURE_LOD_GATHER_FORMAT_PROPERTIES_AMD : return "TEXTURE_LOD_GATHER_FORMAT_PROPERTIES_AMD";
		...
		case VK_STRUCTURE_TYPE_ATTACHMENT_SAMPLE_COUNT_INFO_AMD : return "ATTACHMENT_SAMPLE_COUNT_INFO_AMD";
		case VK_STRUCTURE_TYPE_MULTIVIEW_PER_VIEW_ATTRIBUTES_INFO_NVX : return "MULTIVIEW_PER_VIEW_ATTRIBUTES_INFO_NVX";
		case VK_STRUCTURE_TYPE_STREAM_DESCRIPTOR_SURFACE_CREATE_INFO_GGP : return "STREAM_DESCRIPTOR_SURFACE_CREATE_INFO_GGP";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CORNER_SAMPLED_IMAGE_FEATURES_NV : return "PHYSICAL_DEVICE_CORNER_SAMPLED_IMAGE_FEATURES_NV";
		case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_NV : return "EXTERNAL_MEMORY_IMAGE_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_NV : return "EXPORT_MEMORY_ALLOCATE_INFO_NV";
		case VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_NV : return "IMPORT_MEMORY_WIN32_HANDLE_INFO_NV";
		case VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_NV : return "EXPORT_MEMORY_WIN32_HANDLE_INFO_NV";
		case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV : return "WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV";
		...
		case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_W_SCALING_STATE_CREATE_INFO_NV : return "PIPELINE_VIEWPORT_W_SCALING_STATE_CREATE_INFO_NV";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PER_VIEW_ATTRIBUTES_PROPERTIES_NVX : return "PHYSICAL_DEVICE_MULTIVIEW_PER_VIEW_ATTRIBUTES_PROPERTIES_NVX";
		case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_SWIZZLE_STATE_CREATE_INFO_NV : return "PIPELINE_VIEWPORT_SWIZZLE_STATE_CREATE_INFO_NV";
		...
		case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_TO_COLOR_STATE_CREATE_INFO_NV : return "PIPELINE_COVERAGE_TO_COLOR_STATE_CREATE_INFO_NV";
		...
		case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_MODULATION_STATE_CREATE_INFO_NV : return "PIPELINE_COVERAGE_MODULATION_STATE_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SM_BUILTINS_FEATURES_NV : return "PHYSICAL_DEVICE_SHADER_SM_BUILTINS_FEATURES_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SM_BUILTINS_PROPERTIES_NV : return "PHYSICAL_DEVICE_SHADER_SM_BUILTINS_PROPERTIES_NV";
		...
		case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_SHADING_RATE_IMAGE_STATE_CREATE_INFO_NV : return "PIPELINE_VIEWPORT_SHADING_RATE_IMAGE_STATE_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADING_RATE_IMAGE_FEATURES_NV : return "PHYSICAL_DEVICE_SHADING_RATE_IMAGE_FEATURES_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADING_RATE_IMAGE_PROPERTIES_NV : return "PHYSICAL_DEVICE_SHADING_RATE_IMAGE_PROPERTIES_NV";
		case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_COARSE_SAMPLE_ORDER_STATE_CREATE_INFO_NV : return "PIPELINE_VIEWPORT_COARSE_SAMPLE_ORDER_STATE_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_CREATE_INFO_NV : return "RAY_TRACING_PIPELINE_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_INFO_NV : return "ACCELERATION_STRUCTURE_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_GEOMETRY_NV : return "GEOMETRY_NV";
		case VK_STRUCTURE_TYPE_GEOMETRY_TRIANGLES_NV : return "GEOMETRY_TRIANGLES_NV";
		case VK_STRUCTURE_TYPE_GEOMETRY_AABB_NV : return "GEOMETRY_AABB_NV";
		case VK_STRUCTURE_TYPE_BIND_ACCELERATION_STRUCTURE_MEMORY_INFO_NV : return "BIND_ACCELERATION_STRUCTURE_MEMORY_INFO_NV";
		case VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_NV : return "WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_NV";
		case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_NV : return "ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PROPERTIES_NV : return "PHYSICAL_DEVICE_RAY_TRACING_PROPERTIES_NV";
		case VK_STRUCTURE_TYPE_RAY_TRACING_SHADER_GROUP_CREATE_INFO_NV : return "RAY_TRACING_SHADER_GROUP_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_NV : return "ACCELERATION_STRUCTURE_INFO_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_REPRESENTATIVE_FRAGMENT_TEST_FEATURES_NV : return "PHYSICAL_DEVICE_REPRESENTATIVE_FRAGMENT_TEST_FEATURES_NV";
		case VK_STRUCTURE_TYPE_PIPELINE_REPRESENTATIVE_FRAGMENT_TEST_STATE_CREATE_INFO_NV : return "PIPELINE_REPRESENTATIVE_FRAGMENT_TEST_STATE_CREATE_INFO_NV";
		...
		case VK_STRUCTURE_TYPE_PIPELINE_COMPILER_CONTROL_CREATE_INFO_AMD : return "PIPELINE_COMPILER_CONTROL_CREATE_INFO_AMD";
		case VK_STRUCTURE_TYPE_CALIBRATED_TIMESTAMP_INFO_EXT : return "CALIBRATED_TIMESTAMP_INFO";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_AMD : return "PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_AMD";
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_CAPABILITIES_EXT : return "VIDEO_DECODE_H265_CAPABILITIES";
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_SESSION_PARAMETERS_CREATE_INFO_EXT : return "VIDEO_DECODE_H265_SESSION_PARAMETERS_CREATE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_SESSION_PARAMETERS_ADD_INFO_EXT : return "VIDEO_DECODE_H265_SESSION_PARAMETERS_ADD_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_PROFILE_EXT : return "VIDEO_DECODE_H265_PROFILE";
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_PICTURE_INFO_EXT : return "VIDEO_DECODE_H265_PICTURE_INFO";
		case VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_DPB_SLOT_INFO_EXT : return "VIDEO_DECODE_H265_DPB_SLOT_INFO";
		...
		case VK_STRUCTURE_TYPE_DEVICE_MEMORY_OVERALLOCATION_CREATE_INFO_AMD : return "DEVICE_MEMORY_OVERALLOCATION_CREATE_INFO_AMD";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_NV : return "PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_FEATURES_NV : return "PHYSICAL_DEVICE_MESH_SHADER_FEATURES_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_PROPERTIES_NV : return "PHYSICAL_DEVICE_MESH_SHADER_PROPERTIES_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_IMAGE_FOOTPRINT_FEATURES_NV : return "PHYSICAL_DEVICE_SHADER_IMAGE_FOOTPRINT_FEATURES_NV";
		case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_EXCLUSIVE_SCISSOR_STATE_CREATE_INFO_NV : return "PIPELINE_VIEWPORT_EXCLUSIVE_SCISSOR_STATE_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXCLUSIVE_SCISSOR_FEATURES_NV : return "PHYSICAL_DEVICE_EXCLUSIVE_SCISSOR_FEATURES_NV";
		case VK_STRUCTURE_TYPE_CHECKPOINT_DATA_NV : return "CHECKPOINT_DATA_NV";
		case VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_NV : return "QUEUE_FAMILY_CHECKPOINT_PROPERTIES_NV";
		...
		case VK_STRUCTURE_TYPE_DISPLAY_NATIVE_HDR_SURFACE_CAPABILITIES_AMD : return "DISPLAY_NATIVE_HDR_SURFACE_CAPABILITIES_AMD";
		case VK_STRUCTURE_TYPE_SWAPCHAIN_DISPLAY_NATIVE_HDR_CREATE_INFO_AMD : return "SWAPCHAIN_DISPLAY_NATIVE_HDR_CREATE_INFO_AMD";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_2_AMD : return "PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_2_AMD";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COHERENT_MEMORY_FEATURES_AMD : return "PHYSICAL_DEVICE_COHERENT_MEMORY_FEATURES_AMD";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEDICATED_ALLOCATION_IMAGE_ALIASING_FEATURES_NV : return "PHYSICAL_DEVICE_DEDICATED_ALLOCATION_IMAGE_ALIASING_FEATURES_NV";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_FEATURES_NV : return "PHYSICAL_DEVICE_COOPERATIVE_MATRIX_FEATURES_NV";
		case VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_NV : return "COOPERATIVE_MATRIX_PROPERTIES_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_PROPERTIES_NV : return "PHYSICAL_DEVICE_COOPERATIVE_MATRIX_PROPERTIES_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COVERAGE_REDUCTION_MODE_FEATURES_NV : return "PHYSICAL_DEVICE_COVERAGE_REDUCTION_MODE_FEATURES_NV";
		case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_REDUCTION_STATE_CREATE_INFO_NV : return "PIPELINE_COVERAGE_REDUCTION_STATE_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_FRAMEBUFFER_MIXED_SAMPLES_COMBINATION_NV : return "FRAMEBUFFER_MIXED_SAMPLES_COMBINATION_NV";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_NV : return "PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_NV";
		case VK_STRUCTURE_TYPE_GRAPHICS_SHADER_GROUP_CREATE_INFO_NV : return "GRAPHICS_SHADER_GROUP_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_SHADER_GROUPS_CREATE_INFO_NV : return "GRAPHICS_PIPELINE_SHADER_GROUPS_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_TOKEN_NV : return "INDIRECT_COMMANDS_LAYOUT_TOKEN_NV";
		case VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_NV : return "INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_GENERATED_COMMANDS_INFO_NV : return "GENERATED_COMMANDS_INFO_NV";
		case VK_STRUCTURE_TYPE_GENERATED_COMMANDS_MEMORY_REQUIREMENTS_INFO_NV : return "GENERATED_COMMANDS_MEMORY_REQUIREMENTS_INFO_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_NV : return "PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INHERITED_VIEWPORT_SCISSOR_FEATURES_NV : return "PHYSICAL_DEVICE_INHERITED_VIEWPORT_SCISSOR_FEATURES_NV";
		case VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_VIEWPORT_SCISSOR_INFO_NV : return "COMMAND_BUFFER_INHERITANCE_VIEWPORT_SCISSOR_INFO_NV";
		...
		case VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_RENDER_PASS_TRANSFORM_INFO_QCOM : return "COMMAND_BUFFER_INHERITANCE_RENDER_PASS_TRANSFORM_INFO_QCOM";
		case VK_STRUCTURE_TYPE_RENDER_PASS_TRANSFORM_BEGIN_INFO_QCOM : return "RENDER_PASS_TRANSFORM_BEGIN_INFO_QCOM";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DIAGNOSTICS_CONFIG_FEATURES_NV : return "PHYSICAL_DEVICE_DIAGNOSTICS_CONFIG_FEATURES_NV";
		case VK_STRUCTURE_TYPE_DEVICE_DIAGNOSTICS_CONFIG_CREATE_INFO_NV : return "DEVICE_DIAGNOSTICS_CONFIG_CREATE_INFO_NV";
		...
		case VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_2_NV : return "QUEUE_FAMILY_CHECKPOINT_PROPERTIES_2_NV";
		case VK_STRUCTURE_TYPE_CHECKPOINT_DATA_2_NV : return "CHECKPOINT_DATA_2_NV";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_EARLY_AND_LATE_FRAGMENT_TESTS_FEATURES_AMD : return "PHYSICAL_DEVICE_SHADER_EARLY_AND_LATE_FRAGMENT_TESTS_FEATURES_AMD";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_PROPERTIES_NV : return "PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_PROPERTIES_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_FEATURES_NV : return "PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_FEATURES_NV";
		case VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_SHADING_RATE_ENUM_STATE_CREATE_INFO_NV : return "PIPELINE_FRAGMENT_SHADING_RATE_ENUM_STATE_CREATE_INFO_NV";
		case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_MOTION_TRIANGLES_DATA_NV : return "ACCELERATION_STRUCTURE_GEOMETRY_MOTION_TRIANGLES_DATA_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_MOTION_BLUR_FEATURES_NV : return "PHYSICAL_DEVICE_RAY_TRACING_MOTION_BLUR_FEATURES_NV";
		case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MOTION_INFO_NV : return "ACCELERATION_STRUCTURE_MOTION_INFO_NV";
		...
		case VK_STRUCTURE_TYPE_COPY_COMMAND_TRANSFORM_INFO_QCOM : return "COPY_COMMAND_TRANSFORM_INFO_QCOM";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_FEATURES_ARM : return "PHYSICAL_DEVICE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_FEATURES_ARM";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MUTABLE_DESCRIPTOR_TYPE_FEATURES_VALVE : return "PHYSICAL_DEVICE_MUTABLE_DESCRIPTOR_TYPE_FEATURES_VALVE";
		case VK_STRUCTURE_TYPE_MUTABLE_DESCRIPTOR_TYPE_CREATE_INFO_VALVE : return "MUTABLE_DESCRIPTOR_TYPE_CREATE_INFO_VALVE";
		...
		case VK_STRUCTURE_TYPE_SUBPASS_SHADING_PIPELINE_CREATE_INFO_HUAWEI : return "SUBPASS_SHADING_PIPELINE_CREATE_INFO_HUAWEI";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBPASS_SHADING_FEATURES_HUAWEI : return "PHYSICAL_DEVICE_SUBPASS_SHADING_FEATURES_HUAWEI";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBPASS_SHADING_PROPERTIES_HUAWEI : return "PHYSICAL_DEVICE_SUBPASS_SHADING_PROPERTIES_HUAWEI";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INVOCATION_MASK_FEATURES_HUAWEI : return "PHYSICAL_DEVICE_INVOCATION_MASK_FEATURES_HUAWEI";
		case VK_STRUCTURE_TYPE_MEMORY_GET_REMOTE_ADDRESS_INFO_NV : return "MEMORY_GET_REMOTE_ADDRESS_INFO_NV";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_RDMA_FEATURES_NV : return "PHYSICAL_DEVICE_EXTERNAL_MEMORY_RDMA_FEATURES_NV";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_QCOM : return "PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_QCOM";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_PROPERTIES_QCOM : return "PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_PROPERTIES_QCOM";
		case VK_STRUCTURE_TYPE_SUBPASS_FRAGMENT_DENSITY_MAP_OFFSET_END_INFO_QCOM : return "SUBPASS_FRAGMENT_DENSITY_MAP_OFFSET_END_INFO_QCOM";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINEAR_COLOR_ATTACHMENT_FEATURES_NV : return "PHYSICAL_DEVICE_LINEAR_COLOR_ATTACHMENT_FEATURES_NV";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_PROCESSING_FEATURES_QCOM : return "PHYSICAL_DEVICE_IMAGE_PROCESSING_FEATURES_QCOM";
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_PROCESSING_PROPERTIES_QCOM : return "PHYSICAL_DEVICE_IMAGE_PROCESSING_PROPERTIES_QCOM";
		case VK_STRUCTURE_TYPE_IMAGE_VIEW_SAMPLE_WEIGHT_CREATE_INFO_QCOM : return "IMAGE_VIEW_SAMPLE_WEIGHT_CREATE_INFO_QCOM";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_PROPERTIES_FEATURES_QCOM : return "PHYSICAL_DEVICE_TILE_PROPERTIES_FEATURES_QCOM";
		case VK_STRUCTURE_TYPE_TILE_PROPERTIES_QCOM : return "TILE_PROPERTIES_QCOM";
...
ND_ String  VkRenderPassCreateFlagBitsToString (const VkRenderPassCreateFlagBits value)
{
	switch ( value )
	{
		case VK_RENDER_PASS_CREATE_TRANSFORM_BIT_QCOM : return "TRANSFORM_BIT_QCOM";
	}
	return "<unknown>";
}
...
ND_ String  VkSubpassDescriptionFlagBitsToString (const VkSubpassDescriptionFlagBits value)
{
	switch ( value )
	{
		case VK_SUBPASS_DESCRIPTION_PER_VIEW_ATTRIBUTES_BIT_NVX : return "ATTRIBUTES_BIT_NVX";
		case VK_SUBPASS_DESCRIPTION_PER_VIEW_POSITION_X_ONLY_BIT_NVX : return "POSITION_X_ONLY_BIT_NVX";
		case VK_SUBPASS_DESCRIPTION_FRAGMENT_REGION_BIT_QCOM : return "REGION_BIT_QCOM";
		case VK_SUBPASS_DESCRIPTION_SHADER_RESOLVE_BIT_QCOM : return "SOLVE_BIT_QCOM";
		case VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_COLOR_ACCESS_BIT_ARM : return "TION_ORDER_ATTACHMENT_COLOR_ACCESS_BIT_ARM";
		case VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_ARM : return "TION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_ARM";
		case VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_ARM : return "TION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_ARM";
	}
	return "<unknown>";
}
...
ND_ String  VkPipelineBindPointToString (const VkPipelineBindPoint value)
{
	switch ( value )
	{
		...
		case VK_PIPELINE_BIND_POINT_SUBPASS_SHADING_HUAWEI : return "SUBPASS_SHADING_HUAWEI";
	}
	return "<unknown>";
}
...
ND_ String  VkPipelineStageFlagBits2ToString (const VkPipelineStageFlagBits2 value)
{
	switch ( value )
	{
		...
		case VK_PIPELINE_STAGE_2_TASK_SHADER_BIT_NV : return "TASK_SHADER_BIT_NV";
		case VK_PIPELINE_STAGE_2_MESH_SHADER_BIT_NV : return "MESH_SHADER_BIT_NV";
		case VK_PIPELINE_STAGE_2_SUBPASS_SHADING_BIT_HUAWEI : return "SUBPASS_SHADING_BIT_HUAWEI";
		case VK_PIPELINE_STAGE_2_INVOCATION_MASK_BIT_HUAWEI : return "INVOCATION_MASK_BIT_HUAWEI";
...
ND_ String  VkAccessFlagBits2ToString (const VkAccessFlagBits2 value)
{
	switch ( value )
	{
		...
		case VK_ACCESS_2_COMMAND_PREPROCESS_READ_BIT_NV : return "COMMAND_PREPROCESS_READ_BIT_NV";
		case VK_ACCESS_2_COMMAND_PREPROCESS_WRITE_BIT_NV : return "COMMAND_PREPROCESS_WRITE_BIT_NV";
