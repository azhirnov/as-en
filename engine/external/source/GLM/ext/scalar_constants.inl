...
namespace glm
{
	...
	GLM_NODISCARD GLM_FUNC_QUALIFIER GLM_CONSTEXPR genType epsilon()
	{
	...
	template<typename genType>
	GLM_NODISCARD GLM_FUNC_QUALIFIER GLM_CONSTEXPR genType pi()
	{
	...
	template<typename genType>
	GLM_NODISCARD GLM_FUNC_QUALIFIER GLM_CONSTEXPR genType cos_one_over_two()
	{
