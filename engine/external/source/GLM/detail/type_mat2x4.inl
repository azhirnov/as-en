...
#		endif
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER typename mat<2, 4, T, Q>::col_type & mat<2, 4, T, Q>::operator[](typename mat<2, 4, T, Q>::length_type i)
	{
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_QUALIFIER GLM_CONSTEXPR typename mat<2, 4, T, Q>::col_type const& mat<2, 4, T, Q>::operator[](typename mat<2, 4, T, Q>::length_type i) const
	{
		assert(i < this->length());
		return this->value[i];
	}
