...
namespace glm
{
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL mat<4, 3, T, Q> operator+(mat<4, 3, T, Q> const& m, T const& s);
	...
	template<typename T, qualifier Q>
	GLM_NODISCARD GLM_FUNC_DECL mat<4, 3, T, Q> operator*(T const& s, mat<4, 3, T, Q> const& m);
