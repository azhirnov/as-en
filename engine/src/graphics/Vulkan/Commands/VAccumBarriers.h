...
namespace AE::Graphics::_hidden_
{
	...
	// methods
	private:
		VAccumBarriers (Ctx &ctx) : _ctx{&ctx} {}

	public:
		VAccumBarriers () = delete;
		VAccumBarriers (const Self &) = delete;
		VAccumBarriers (Self &&) = default;
		~VAccumBarriers ()						{ if ( _ctx ) _ctx->CommitBarriers(); }
	...
	// methods
	private:
		VAccumDrawBarriers (Ctx &ctx) : _ctx{&ctx} {}

	public:
		VAccumDrawBarriers () = delete;
		VAccumDrawBarriers (const Self &) = delete;
		VAccumDrawBarriers (Self &&) = default;
		~VAccumDrawBarriers ()						{ if ( _ctx ) _ctx->CommitBarriers(); }
