namespace RenderTechs
{
	...
	static constexpr struct _MeshForward
	{
		...
		static constexpr struct _Graphics1
		{
			...
			static constexpr PipelineName_t  mesh_2_rp_Simple {"mesh_2 rp:Simple"};
		} Graphics1;
	} MeshForward;
	...
	static constexpr struct _RayTracing
	{
		...
		static constexpr struct _Trace1
		{
			...
			// pipelines
			static constexpr PipelineName_t  raytracing_1_def {"raytracing_1.def"};
		} Trace1;

		static constexpr struct _SBT {
			static constexpr RTShaderBindingName_t  raytracing_1_sbt0 {"raytracing_1.sbt0"};
		} sbt;
	} RayTracing;
