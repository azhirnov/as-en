...
namespace
{
	...
	static void  Frustum_Test1 ()
	{
		...
		TEST( All(Equals( rays[0], float3{ 0.6f, -0.4f, -0.69f}, 0.05f )) );
		TEST( All(Equals( rays[1], float3{ 0.6f,  0.4f, -0.69f}, 0.05f )) );
		TEST( All(Equals( rays[2], float3{-0.6f, -0.4f, -0.69f}, 0.05f )) );
		TEST( All(Equals( rays[3], float3{-0.6f,  0.4f, -0.69f}, 0.05f )) );
	}
