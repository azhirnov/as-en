...
void main ()
{
	...
	FeatureSet@  fset = FeatureSet( "MinMobileMali" );
	...
	fset.perDescrSet_minSamplers (768);
	...
	fset.minFragmentCombinedOutputResources (12);
	...
	fset.AddTexelFormats( EFormatFeature::LinearSampled, {
		...
		EPixelFormat::RGB_11_11_10F, EPixelFormat::RGB_9F_E5, EPixelFormat::Depth16, EPixelFormat::Depth24, 
