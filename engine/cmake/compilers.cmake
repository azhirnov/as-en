...
if ( COMPILER_MSVC )
	...
	set( MSVC_SHARED_OPTS /std:c++latest /MP /Gm- /Zc:inline /Gy- /fp:strict /fp:except- /DAE_COMPILER_MSVC /D_SILENCE_CXX20_CISO646_REMOVED_WARNING /JMC
		 "/DAE_PLATFORM_TARGET_VERSION_MAJOR=${WINDOWS_TARGET_VERSION_MAJ}" "/DAE_PLATFORM_TARGET_VERSION_MINOR=${WINDOWS_TARGET_VERSION_MIN}"
	...
	set( PROJECTS_SHARED_CXX_FLAGS_DEBUG ${MSVC_SHARED_OPTS_DBG}  /W4 /WX- /sdl /Od /Ob0 /Oy- /GF- /GS /GR /analyze- /Zi /RTCsu CACHE INTERNAL "" FORCE )
...
if ( COMPILER_GCC )
	...
	set( CMAKE_C_FLAGS_DEBUG "${CURRENT_C_FLAGS} -D_DEBUG -O0 ${GCC_CLANG_SHARED_GLOBAL_WARNING_LIST}" CACHE STRING "" FORCE )
	set( CMAKE_CXX_FLAGS_DEBUG "${CURRENT_CXX_FLAGS} -D_DEBUG -O0 ${GCC_CLANG_SHARED_GLOBAL_WARNING_LIST}" CACHE STRING "" FORCE )
...
if ( COMPILER_CLANG )
	...
	# Debug
	set_property( DIRECTORY APPEND PROPERTY COMPILE_DEFINITIONS $<$<CONFIG:Debug>: > )
	set( CMAKE_C_FLAGS_DEBUG "${CURRENT_C_FLAGS} -D_DEBUG -O0 ${CLANG_SHARED_GLOBAL_WARNING_LIST}" CACHE STRING "" FORCE )
	set( CMAKE_CXX_FLAGS_DEBUG "${CURRENT_CXX_FLAGS} -D_DEBUG -O0 ${CLANG_SHARED_GLOBAL_WARNING_LIST}" CACHE STRING "" FORCE )
	set( CMAKE_EXE_LINKER_FLAGS_DEBUG "${CURRENT_EXE_LINKER_FLAGS} " CACHE STRING "" FORCE )
	set( CMAKE_STATIC_LINKER_FLAGS_DEBUG "${CURRENT_STATIC_LINKER_FLAGS} " CACHE STRING "" FORCE )
	set( CMAKE_SHARED_LINKER_FLAGS_DEBUG "${CURRENT_SHARED_LINKER_FLAGS} " CACHE STRING "" FORCE )
...
if ( COMPILER_CLANG_APPLE )
	...
	set( CLANG_SHARED_OPTS -DAE_COMPILER_CLANG -DAE_PLATFORM_TARGET_VERSION_MAJOR=${APPLE_VER_MAJ} -DAE_PLATFORM_TARGET_VERSION_MINOR=${APPLE_VER_MIN}
		 ${COMPILER_FLAGS} ${CLANG_SHARED_LOCAL_WARNING_LIST} -Werror=objc-method-access -Werror=unguarded-availability )
...
if ( COMPILER_CLANG_ANDROID )
	...
	set( CLANG_SHARED_OPTS -DAE_COMPILER_CLANG ${COMPILER_FLAGS} ${CLANG_SHARED_LOCAL_WARNING_LIST} -fstack-protector-strong -fPIC -mfloat-abi=hard )
